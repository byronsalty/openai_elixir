...
defmodule OpenAIAPI.Api.OpenAI do
  ...
  - `connection` (OpenAIAPI.Connection): Connection to server
  - `image` (String.t): The image to edit. Must be a valid PNG file, less than 4MB, and square.
  ...
  - `opts` (keyword): Optional parameters
    ...
    - `:user` (String.t): A unique identifier representing your end-user, which will help OpenAI to monitor and detect abuse. [Learn more](/docs/usage-policies/end-user-ids). 
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec create_image_edit(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, OpenAIAPI.Model.ImagesResponse.t} | {:error, Tesla.Env.t}
  def create_image_edit(connection, image, mask, prompt, opts \\ []) do
    optional_params = %{
      :n => :form,
      :size => :form,
